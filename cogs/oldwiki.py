...
class Oldwiki(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
    
    @app_commands.command(name="oldwiki", description="Search the Sea of Thieves Fandom Wiki")
    async def oldwiki(self, interaction: discord.Interaction, search: str, amount_of_results: int = None):
        #Config
        wikiname = "Sea of Thieves"
